...
namespace DevionGames.InventorySystem
{
    ...
    public class InventorySystemInspector
    {
        ...
        private void SelectDatabaseButton() {
            ...
            {
                    ObjectPickerWindow.ShowWindow(buttonRect, typeof(ItemDatabase), (UnityEngine.Object obj) =>
                    { 
        ...
        private void ResetChildEditors() {
            ...
            if (this.m_Database != null)
            {
                ...
                this.m_ChildEditors.Add(new ItemCollectionEditor(this.m_Database, this.m_Database.items, this.m_Database.categories.
