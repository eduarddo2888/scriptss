    ...
    public class VisibleItemsEditor : AssetWindow
    {
        ...
        public new static void ShowWindow(string title, SerializedProperty elements)
        {
            ...
            for (int i = 0; i < elements.arraySize; i++)
            {
                ...
                window.m_Targets[i].hideFlags = EditorPrefs.GetBool("InventorySystem.showAllComponents") ? HideFlags.None:HideFlags.
                    HideInInspector;
        ...
        private void DrawElementList()
        {
          /*  GUIStyle selectButton = new GUIStyle("MeTransitionSelectHead")
            ...
            for (int i = 0; i < this.m_Targets.Length; i++)
            {
                ...
                Rect rect = GUILayoutUtility.GetRect(new GUIContent((item != null ? item.Name : "Null")), VisibleItemsEditor.m_Styles.
                    elementButtonText, GUILayout.Height(25f));
                rect.width -= 25f;
        ...
        {
            GUIContent content = new GUIContent((this.m_SelectedIndex != -1) ? (this.m_SelectedItem != null ? this.m_SelectedItem.Name :
                "Null") : "Items");
        ...
        private class Styles
        {
            ...
            public Styles()
            {
                ...
                elementButtonText.normal.textColor = EditorGUIUtility.isProSkin ? new Color(0.788f, 0.788f, 0.788f, 1f) :
